...
void loop() { 
  ...
  switch(selectedEffect) {
    ...
    case 4  : {
                ...
                CylonBounce(0xff, 0x00, 0xff, 4, 10, 50);
                break;
              }
    ...
    case 6  : {
                ...
                Twinkle(0xff, 0xff, 0xff, 20, 100, false);
                break;
              }
    ...
    case 13 : {
                ...
                theaterChase(0xff,0xff,0xff,15);
                break;
              }

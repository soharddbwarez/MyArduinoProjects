...
#else
int XP = 8, YP = A3, XM = A2, YM = 9;  //My Custom Touch Pin Wiring Configuration
...
// Customized color chart defining more colors
#define BLACK   0x0000
#define GRAY    0x8410
#define WHITE   0xFFFF
#define RED     0xF800
...
void readResistiveTouch(void)
{
    ...
    // The string below was commented out, I changed it temporary so now you see the touchscreen output
    // as a continues serial data stream when you open the serial monitor

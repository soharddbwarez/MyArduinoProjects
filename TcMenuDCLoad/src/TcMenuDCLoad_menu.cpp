...
const PROGMEM AnyMenuInfo minfoSettingsMaxP = { "Max P", 9, 0xffff, 0, SetMaxP };
ActionMenuItem menuSettingsMaxP(&minfoSettingsMaxP, NULL);
const PROGMEM AnyMenuInfo minfoSettingsMaxA = { "Max A", 8, 0xffff, 0, SetMaxA };
ActionMenuItem menuSettingsMaxA(&minfoSettingsMaxA, &menuSettingsMaxP);
const PROGMEM AnyMenuInfo minfoSettingsMaxV = { "Max V", 7, 0xffff, 0, SetMaxV };
ActionMenuItem menuSettingsMaxV(&minfoSettingsMaxV, &menuSettingsMaxA);
RENDERING_CALLBACK_NAME_INVOKE(fnSettingsScreenBrightnessRtCall, enumItemRenderFn, "ScreenBrightness", 4, SetScreenBrightness)
ScrollChoiceMenuItem menuSettingsScreenBrightness(6, fnSettingsScreenBrightnessRtCall, 0, 0, 10, 0, &menuSettingsMaxV);
...
RENDERING_CALLBACK_NAME_INVOKE(fnAmpsRtCall, textItemRenderFn, "Amps", -1, GetAmps)
TextMenuItem menuAmps(fnAmpsRtCall, 2, 5, &menuDCLoad);
RENDERING_CALLBACK_NAME_INVOKE(fnVoltRtCall, textItemRenderFn, "Volt", -1, GetVoltage)
